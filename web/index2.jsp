...
//			}
		...
		<%@include file="partitials/head.jsp" %>
		<!-- End: Header -->
				...
				<div class="sidebar">
								...
								<ul class="nav nav-sidebar">
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li><a href="pages/404.html"><span class="text"> 404</span></a></li>
											<li><a href="pages/500.html"><span class="text"> 500</span></a></li>
											<li><a href="pages/login.html"><span class="text"> Login Page</span></a></li>
											<li><a href="pages/register.html"><span class="text"> Register Page</span></a></li>
										</ul>
									</li>
									<li>
					...
					<div class="sidebar-footer">	
						<ul class="sidebar-terms">
							<li><a href="index2.jsp#">Terms</a></li>
							<li><a href="index2.jsp#">Privacy</a></li>
							<li><a href="index2.jsp#">Help</a></li>
							<li><a href="index2.jsp#">About</a></li>
						</ul>
						<div class="copyright text-center">
							<small>Plutus @ yflog.com</small>
						</div>					
					</div>
					<!-- End Sidebar Footer-->
				</div>
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								<li><a href="index2.jsp"><i class="icon fa fa-home"></i>Home</a></li>
							...
							<div class="panel">
								<div class="panel-heading bk-bg-primary">
									...
									<div class="panel-actions">
										<a href="index2.jsp#" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
										<a href="index2.jsp#" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
										<a href="index2.jsp#" class="btn-close"><i class="fa fa-times"></i></a>
									</div>	
								</div>						
